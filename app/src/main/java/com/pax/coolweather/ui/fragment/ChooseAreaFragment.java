package com.pax.coolweather.ui.fragment;
        ...
        HttpUtil.sendOKHttpRequest(address, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                getActivity().runOnUiThread(() -> {
                    closeProgressDialog();
                    ToastUtil.showToast(getActivity(), "加载失败:" + e.getLocalizedMessage());
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                switch (type) {
                    case "province":
                        Log.i(Const.TAG, "onResponse: responseText=" + responseText);
